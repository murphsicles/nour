//! Peer-to-peer network protocol messages for Bitcoin SV.
//!
//! Supports all message types for P2P communication (addr, block, tx, etc.), with serialization/deserialization.
//! Designed for high-throughput applications; use `async` feature for non-blocking I/O.
//!
//! # Examples
//!
