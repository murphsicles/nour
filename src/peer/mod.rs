...
//! user_agent: "rust-nour".to_string(),
//! ..Default::default()
//! };
//!
...
//!
//! ```no_run, rust
//! use nour::messages::{Version, NODE_BITCOIN_CASH, PROTOCOL_VERSION};
//! use nour::network::NetworkConfig;
//! use nour::peer::{Peer, PeerConnected, PeerDisconnected, PeerMessage, SVPeerFilter};
//! use nour::util::rx::{Observable, Observer};
//! use nour::util::secs_since;
//! use std::sync::Arc;
//! use std::time::UNIX_EPOCH;
//!
